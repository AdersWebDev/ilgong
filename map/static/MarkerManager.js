...
class MarkerManager {
        ...
        if (hasEvent) {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="92" viewBox="0 0 80 92" fill="none">
                ...
                <g>
                    ...
                    <text x="66" y="16" font-family="'Noto Sans KR', sans-serif" font-size="14" font-weight="600" fill="#FB8525" text-anchor="end" dominant-baseline="central">핫딜</text>
                </g>
            </svg>
            `;
        ...
        if (eventId) {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="72" height="56" viewBox="0 0 72 56" fill="none">
                ...
                <g>
                    ...
                    <text x="62" y="16" font-family="'Noto Sans KR', sans-serif" font-size="14" font-weight="600" fill="#FB8525" text-anchor="end" dominant-baseline="central">핫딜</text>
                </g>
            </svg>
            `;
    ...
    createInfoWindowContent(location) {
        ...
        // 상세 페이지 URL (경로 형식: /map/detail/:producer/:id)
        const detailUrl = location.id && location.producer ? `/map/detail/${location.producer}/${location.id}` : '#';
        return `
