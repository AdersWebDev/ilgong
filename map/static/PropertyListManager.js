...
class PropertyListManager {
        ...
        container.innerHTML = propertiesToShow.map(property => `
            <div class="property-card" 
                ...
                <div class="property-card-image">
                    <img src="${property.thumbnail || ''}" alt="${property.address}" loading="lazy" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22260%22 height=%22160%22%3E%3Crect fill=%22%23f0f0f0%22 width=%22260%22 height=%22160%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%2２.3em%２２ fill=%２２%23999%２２%3ENo Image%3C/text%3E%3C/svg%3E';">
    ...
    /**
     * 더 많은 프로퍼티 로드 (패널 API 페이지 기반, page ≤ 5)
     */
    loadMoreProperties() {
