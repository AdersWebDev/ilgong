        ...
        if (propertiesToShow.length === 0) {
            container.innerHTML = `
                <div style="text-align: center; padding: 40px; color: #666; grid-column: span 2;">
                    ...
                    <p style="font-size: 16px;">検索結果がありません。</p>
                    <p style="font-size: 14px; margin-top: 8px;">フィルター条件を変更してみてください。</p>
                </div>
            `;
            return;
        }
        container.innerHTML = propertiesToShow.map(property => `
            <div class="property-card" 
                ...
                <div class="property-card-image">
                    <img src="${property.thumbnail || ''}" alt="${property.address}" loading="lazy" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22260%22 height=%22160%22%3E%3Crect fill=%22%23f0f0f0%22 width=%22260%22 height=%22160%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%23999%22%3ENo Image%3C/text%3E%3C/svg%3E';">
