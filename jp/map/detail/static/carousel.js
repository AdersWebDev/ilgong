...
const PropertyCarousel = {
    ...
    renderUnitsByPage() {
        ...
        unitsToRender.forEach((unit) => {
            ...
            const statusText = unit.statusText || '公室';
            ...
            const depositValue = unit.deposit && unit.deposit !== '0円' ? unit.deposit : 'なし';
            const gratuityValue = unit.gratuity || 'なし';
            ...
            card.innerHTML = `
                ...
                <div class="room right">
                    <div class="room-right-wrapper">
                        <div class="unit-more-info">
                            <div>賃料</div>
                            <div class="unit-price-value">${unit.rent ? unit.rent.toLocaleString('ja-JP') + '円' : 'お問い合'}</div>
                        </div>
                        <div class="unit-more-info">
                            <div>管理費</div>
                            <div class="unit-price-value">${unit.commonFee ? unit.commonFee + '円' : 'お問い合'}</div>
                        </div>
                        <div class="unit-more-info">
                            <div>敷金</div>
