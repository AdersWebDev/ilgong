    ...
    updateRelativeTime() {
        ...
        try {
            ...
            if (Number.isNaN(diffMs)) {
                this.updateTimeElement.innerHTML = '<span class="clock-svg" style="content: url(../../../map/detail/assest/clock.svg);"></span>更新情報なし';
                return;
            }
            ...
            if (diffMinutes < 1) relativeTime = 'さきほど';
            else if (diffMinutes < 60) relativeTime = `${diffMinutes}分前`;
            else if (diffHours < 24) relativeTime = `${diffHours}時間 前`;
            else if (diffDays < 7) relativeTime = `${diffDays}日 前`;
            else {
            ...
            this.updateTimeElement.innerHTML = `<span class="clock-svg" style="content: url(../../../map/detail/assest/clock.svg);"></span>${relativeTime} 更新`;
        } catch (error) {
